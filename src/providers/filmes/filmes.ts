...
export class FilmesProvider {
  ...
  movieTopRated() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}movie/top_rated?api_key=${ENV.API_KEY}&language=pt-BR`)
  }

  movieRecommendation() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}trending/all/week?api_key=${ENV.API_KEY}&language=pt-BR`)
  }
  ...
  movieComedy() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}discover/tv?with_genres=35&api_key=${ENV.API_KEY}&language=pt-BR`)
  }

  movieTerror() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}discover/tv?with_genres=27&api_key=${ENV.API_KEY}&language=pt-BR`)
  }

  movieRomance() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}discover/tv?with_genres=10749&api_key=${ENV.API_KEY}&language=pt-BR`)
  }

  movieDocumentary() {
    return this.http.get<FilmesModel>(`${ENV.API_BASE}discover/tv?with_genres=99&api_key=${ENV.API_KEY}&language=pt-BR`)
  }
